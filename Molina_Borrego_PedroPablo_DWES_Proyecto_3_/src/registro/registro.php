...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($tipo_usuario === 'bibliotecario' && (empty($codigo) || $codigo !== $codigo_correcto)) {
        $error = "Código especial para bibliotecarios incorrecto.";
    }
...
<br><br>
    <div class="form-container">
        ...
        <form action="registro.php" method="POST">
            ...
            <input type="text" id="telefono" name="telefono" placeholder="Tu teléfono (opcional)" maxlength="9" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
            ...
            <input type="text" id="codigo" name="codigo" placeholder="Código para bibliotecarios: ADMIN123">
