      ...
      <nav class='navbar navbar-expand-md navbar-dark bg-dark mb-4'>
        <div class='container-fluid'>
          ...
          <ul class='navbar-nav me-auto mb-2 mb-md-0'>
            ...
            <li class='nav-item'>
              <a class='nav-link active <?php echo ($currentPage == 'transactions-edit') ? 'active bg-secondary' : ''; ?>' href='<?php echo $routes->get('transactions.edit')->getPath(); ?>'>Editar</a>
            </li>
            <li class='nav-item'>
              <a class='nav-link active <?php echo ($currentPage == 'transactions-destroy') ? 'active bg-secondary' : ''; ?>' href='<?php echo $routes->get('transactions.destroySelect')->getPath(); ?>'>Eliminar</a>
            </li>
            <li class='nav-item'>
              <a class='nav-link active <?php echo ($currentPage == 'transactions-generar') ? 'active bg-secondary' : ''; ?>' href='<?php echo $routes->get('transactions.generar')->getPath(); ?>'>GenerarPDF</a>
            </li>
